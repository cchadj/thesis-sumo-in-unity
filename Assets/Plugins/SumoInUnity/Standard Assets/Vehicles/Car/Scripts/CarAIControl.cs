...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        public float DesiredSpeed { get => _desiredSpeed; set => _desiredSpeed = value; }
        ...
        private void FixedUpdate()
        {
            ...
            else
            {
                    ...
                    case BrakeCondition.TargetDirectionDifference:
                        {
                            ...
                            /* MY CHANGES According to https://answers.unity.com/questions/1311552/unity-standard-asset-waypoint-car-ai-breaking.html
                             * m_Rigidbody.angularVelocity.magnitude is in radians but m_CautiousMaxAngle is in degrees and we need to convert it to degrees.
                             */
                            spinningAngle = Mathf.Rad2Deg * spinningAngle;

                            // if it's different to our current angle, we need to be cautious (i.e. slow down) a certain amount
                            float cautiousnessRequired = Mathf.InverseLerp(0, m_CautiousMaxAngle,
                                                                           Mathf.Max(spinningAngle,
                                                                                     approachingCornerAngle));
                            _desiredSpeed = Mathf.Lerp(m_CarController.MaxSpeed, m_CarController.MaxSpeed*m_CautiousSpeedFactor,
                ...
                if (Time.time < m_AvoidOtherCarTime)
                {
                    ...
                    _desiredSpeed *= m_AvoidOtherCarSlowdown;
                ...
                float accelBrakeSensitivity = (_desiredSpeed < m_CarController.CurrentSpeed)
                                                  ? m_BrakeSensitivity
                                                  : m_AccelSensitivity;

                // decide the actual amount of accel/brake input to achieve desired speed.
                float accel = Mathf.Clamp((_desiredSpeed - m_CarController.CurrentSpeed)*accelBrakeSensitivity, -1, 1);
                ...
                /* MYNOTES When Drive is set to true when is set to false then it completely stops
                 * Can be fixed by this -> https://answers.unity.com/questions/1111987/standard-assets-carwaypointbased-how-to-let-the-ve.html */
