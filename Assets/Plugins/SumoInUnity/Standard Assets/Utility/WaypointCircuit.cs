...
namespace UnityStandardAssets.Utility
{
    public class WaypointCircuit : MonoBehaviour
    {
        ...
        public virtual Transform[] Waypoints
        {
            get { return waypointList.items; }
        }

        protected bool SmoothRoute { get => _smoothRoute; set => _smoothRoute = value; }
        protected int NumPoints { get => _numPoints; set => _numPoints = value; }
        ...
        public virtual RoutePoint GetRoutePoint(float dist)
        {
